...
<head>
    ...
    <link rel="apple-touch-icon" sizes="144x144" type="image/x-icon" href="/resources/images/favicon/apple-touch-icon.png">

	<!-- All CSS Plugins -->
    <link rel="stylesheet" type="text/css" href="/resources/css/navPlugin.css">
